...
test("o runtime config público aceita somente o contrato canônico", () => {
  ...
  for (const mutate of [
    (value) => (value.secret = "never"),
    (value) => (value.api_base_url = "https://evil.example"),
    (value) => (value.api_base_url += "/stage"),
    (value) => (value.cognito.redirect_uri = "https://senai.maib.com.br/callback"),
    (value) => (value.cognito.scopes = ["openid", "aws.cognito.signin.user.admin"]),
    (value) =>
