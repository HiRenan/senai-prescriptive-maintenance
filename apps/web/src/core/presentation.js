...
import { fieldLabel } from "./features.js";

/**
 * @typedef {import("../generated/analysis-contract.js").AnalysisResponse} AnalysisResponse
 * @typedef {import("../generated/analysis-contract.js").AnalysisOutcome} AnalysisOutcome
 * @typedef {import("../generated/analysis-contract.js").Citation} Citation
 * @typedef {import("../generated/analysis-contract.js").OpaqueNeighbor} OpaqueNeighbor
 * @typedef {import("../generated/analysis-contract.js").AnalysisWarning} AnalysisWarning
 * @typedef {import("../api/analysis-client.js").AnalysisFailure} AnalysisFailure
 */
 ...
 * @property {string | null} priorityLabel
 * @property {readonly string[]} actions
 */

/**
 * @typedef {object} ReportView
 * @property {"result" | "failure"} kind
 * @property {string} tone
 * @property {string | null} outcome
 * @property {string} title
 * @property {string} statement
 * @property {string} nextStep
 * @property {readonly {label: string, value: string}[]} identifiers
 * @property {{code: string, summary: string} | null} diagnosis
 * @property {{level: string, label: string, score: number, note: string} | null} support
 * @property {{reason: string, label: string, message: string} | null} abstention
 * @property {PrescriptionView} prescription
 * @property {readonly Citation[]} citations
 * @property {readonly OpaqueNeighbor[]} neighbors
 * @property {string} neighborNote
 * @property {readonly AnalysisWarning[]} warnings
 * @property {readonly string[]} integrity
 * @property {readonly {label: string, code: string}[]} issues
 */

/**
 * @param {string} outcome
 * @returns {import("../generated/analysis-contract.js").OutcomeContract | undefined}
 */
function outcomeContract(outcome) {
 ...
 * @param {import("../generated/analysis-contract.js").OutcomeContract} contract
 * @returns {{ state: string, integrity: readonly string[] }}
 */
function resolvePrescriptionState(response, contract) {
  ...
  const validPriority =
    ...
    PRESCRIPTION_PRIORITIES.includes(
      /** @type {import("../generated/analysis-contract.js").PrescriptionPriority} */ (
        priority
      ),
    );
 ...
 * @param {string} state
 * @param {string} outcome
 * @returns {{ heading: string, explanation: string }}
 */
function prescriptionCopy(state, outcome) {
 ...
 * @returns {ReportView}
 */
export function presentAnalysis(response) {
 ...
 *
 * @param {AnalysisFailure} failure
 * @returns {ReportView}
 */
export function presentFailure(failure) {
