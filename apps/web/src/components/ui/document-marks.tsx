 ...
 * for readers who do not perceive the tone colour. Ported unchanged from the
...
const PATHS: Readonly<Record<DocumentStatusName, readonly string[]>> =
  Object.freeze({
...
export function DocumentMark({
  ...
  const paths = PATHS[status as DocumentStatusName] ?? PATHS.failed;
  return (
    <svg
      className="mark"
      viewBox="0 0 24 24"
